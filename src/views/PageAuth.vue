...
const linkAccountText = computed<string>(() => {
  return isLogin.value ? 'Создать аккаунт' : 'Войти'
})
...
<template>
  ...
  <div class="flex justify-content-center p-2">
    <div class="suface-card p-4 shadow-2 border-round w-full lg:w-6">
      <div class="text-center mb-3">
        <div class="text-900 text-3xl font-medium mb-3">Приветсвую!</div>
